...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        // Bibiere brand colors
        bibiere: {
          burgundy: "#8B1538", // Deep burgundy primary
          gold: "#D4AF37", // Warm gold accent
          "burgundy-dark": "#6B1028", // Darker burgundy for hover states
          "gold-light": "#E6C547", // Lighter gold for hover states
        },
