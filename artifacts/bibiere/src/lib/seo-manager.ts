...
export class SEOManager {
  ...
  generateMetadata(pageData: Partial<SEOMetadata> & { path?: string; params?: Record<string, string> }): Record<string, unknown> {
  ...
  generateProductMetadata(product: ProductData, path: string, params?: Record<string, string>): Record<string, unknown> {
