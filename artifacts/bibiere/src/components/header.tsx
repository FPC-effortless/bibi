...
import { Search, Heart, User, Menu, X, LogIn } from "lucide-react"
          ...
          >
            <nav className="py-4 space-y-1 border-t border-sidebar-border safe-area-bottom">
              ...
              <Show when="signed-in">
                ...
                <button
                  className="sm:hidden block w-full text-left px-6 py-4 text-sidebar-foreground hover:text-red-500 hover:bg-red-50 transition-all duration-300 font-medium rounded-lg mx-2 min-h-touch-md flex items-center text-responsive"
