      ...
      <div className="w-full max-w-md space-y-8">
        <div className="text-center space-y-2">
          ...
          <p className="text-muted-foreground">
            Join bibiere for exclusive access to luxury fashion
          </p>
        </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-2">
                ...
                <Label htmlFor="terms" className="text-sm leading-relaxed">
                  I agree to the{" "}
                  <Link href="/terms" className="text-bibiere-burgundy hover:underline">
                    Terms of Service
                  </Link>{" "}
                  and{" "}
                  <Link href="/privacy" className="text-bibiere-burgundy hover:underline">
                    Privacy Policy
                  </Link>
                </Label>
              </div>
